...
public interface InterviewDAO {
	...
	//받은상담리스트
		...
		List<InterviewDTO> searchinterviewlist(Search search);
		
		List<InterviewDTO> receivedinterviewlist(Pagination pagination);
	...
	//상담내역리스트
//		public List<InterviewDTO> sendinterviewlist(HashMap<String,Object> map);
