...
public class DateData {
	...
	public Map<String, Integer> today_info(DateData dateData) {
		...
		cal.set(Integer.parseInt(dateData.getYear()), Integer.parseInt(dateData.getMonth()) - 1, 1);
	...
	private AttendanceDTO attDTO;

	public AttendanceDTO getAttDTO() {
		return attDTO;
	}

	public void setAttDTO(AttendanceDTO attDTO) {
		this.attDTO = attDTO;
	}
