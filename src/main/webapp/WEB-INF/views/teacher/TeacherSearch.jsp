			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">강사리스트</h1>
						<a href="#"
					...
					<div class="container-fluid">
						...
						<!-- Page Heading -->
						<p class="mb-4">
							관리자에게 보여지는 강사리스트화면 입니다 
						</p>

						<!-- DataTales Example -->
						<div class="card shadow mb-4">
							<div class="card-header py-3">
								<h6 class="m-0 font-weight-bold text-primary">강사리스트</h6>
							</div>
...
<script>
	$(document).ready(function () {
	    $("#searchBtn").on("click", function (event) {
	        self.location =
	            "${ContextPath}/TeacherSearch${pageMaker.makeQuery(1)}"
