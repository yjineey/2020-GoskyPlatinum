			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">회원 등록하기</h1>
					</div>
					<!-- Begin Page Content -->
					<div class="container-fluid">
							...
							<div class="col-lg-12">
								<div class="p-5">
									<div class="text-center">
										<h1 class="h4 text-gray-900 mb-4">회원 등록하기</h1>
									</div>
									
									<form class="user" onsubmit="return checkVar();" action="${ContextPath }/signup/maddMember" method="post">
