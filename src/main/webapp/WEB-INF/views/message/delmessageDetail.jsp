...
<!-- 제목 -->
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">휴지통 - 메시지 상세보기</h1>
...
<!-- 내용 시작 -->			
			...
			<button class="btn btn-success">목록가기</button>
			<button class="btn btn-primary">삭제취소</button>
			<button class="btn btn-danger">완전히 삭제</button>
	...
	$(function(){
		...
		$(".btn-success").click(function(){
			location.href="delmessagelist";
		});
		
		//삭제취소
		$(".btn-primary").click(function(){
			location.href="delmessagecansle?msno="+${detail.msno};
		});
		
		//삭제 버튼을 눌렀을 때 처리
		$(".btn-danger").click(function(){
			location.href="delete2?msno="+${detail.msno}  ;
		});
