					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							<div class="table-responsive">
								...
								<c:import url="/WEB-INF/views/attendance/include/date.jsp" />
								
								<c:import url="/WEB-INF/views/attendance/include/search.jsp" />
								
								<c:import url="/WEB-INF/views/attendance/include/list-card.jsp" />
