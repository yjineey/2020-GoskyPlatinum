...
<c:import url="/WEB-INF/views/subject/include/title.jsp" />
			...
			<div id="main-content">
				...
				<div class="container-fluid">
					...
					<div class="d-sm-flex align-items-center justify-content-between mb-4" id="pageHeading">
						<h1 class="h3 mb-0 text-gray-800">강의 ${empty subject ? '등록' : '정보 조회 및 수정'}</h1>
					</div>

				</div>

				<c:import url="/WEB-INF/views/subject/include/regist-card.jsp" />
