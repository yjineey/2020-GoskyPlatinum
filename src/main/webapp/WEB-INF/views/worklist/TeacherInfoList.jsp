			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">강사검색</h1>
						<a href="#"
					...
					<div class="container-fluid">
						...
						<!-- Page Heading -->
						<p class="mb-4">
							관리자에게 보여지는 강사검색화면 입니다 <a target="_blank"
						...
						<div class="card shadow mb-4">
							<div class="card-header py-3">
								<h6 class="m-0 font-weight-bold text-primary">강사검색</h6>
							</div>
												...
												<c:when test="${fn:length(TeacherList) > 0}">
													<c:forEach var="TeacherList" items="${TeacherList }" >
														...
														<td>${TeacherList.mno}</td>
															<td><a href="${ContextPath}/TeacherInfoUpdate?mid=${TeacherList.mid}">${TeacherList.mname}</a></td>
