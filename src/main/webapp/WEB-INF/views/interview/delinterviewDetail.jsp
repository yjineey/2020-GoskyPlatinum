...
<!-- 제목 -->
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">휴지통 - 상담내용 상세보기</h1>
...
<!-- 내용 시작 -->			
			...
			<button class="btn btn-danger">완전삭제</button>
	...
	$(function(){
		...
		$(".btn-primary").click(function(){
			location.href="delinterviewcansle?msno="+${detail.msno};
		});
		//삭제 버튼을 눌렀을 때 처리
		$(".btn-danger").click(function(){
			location.href="idelete2?msno=" + ${detail.msno};
		});
