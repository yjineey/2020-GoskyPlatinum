			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">회원 상세보기</h1>
						<a href="#"
					...
					<div class="container-fluid">
						...
						<!-- Page Heading -->
						<p class="mb-4">
							회원정보 상세보기 페이지 입니다. 회원정보 및 USER 정보를 수정할 수 있습니다. 
						</p>
								...
								<div class="table-responsive">
									<section class="content">
										<form role="form" method="post"
											action="${ContextPath}/MemberMypageUpdate?mid=${member.mid}">
						...
						<div class="card shadow mb-4">
							<div class="card-header py-3">
								<h6 class="m-0 font-weight-bold text-primary">USER 정보  &nbsp;&nbsp;&nbsp;
										...
										<button type="button" class="btn btn-primary" id="write">USER추가</button></c:if></h6>
							</div>
							<div class="card-body">
								<div class="table-responsive">
									<section class="content">
										...
										<c:forEach var="people" items="${people }">
									 	<form role="form" method="post" action="${ContextPath}/PeopleMypageUpdate?mid=${people.mid}">
												<table class="table table-bordered" id="dataTable">
													<tbody>
														<tr>
															<td rowspan="2">${member.img}</td>
														...
														<tr>
															...
															<th>성별</th>
															<td>
													<br><br><label for="male">남자&nbsp;</label><input type="radio" id="male" name="psex" value="male" checked>&nbsp;&nbsp;
